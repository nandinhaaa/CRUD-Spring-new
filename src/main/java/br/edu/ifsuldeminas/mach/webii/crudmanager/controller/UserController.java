...
public class UserController {
	...
	@GetMapping("/users") // req chama e so vai ser atendida se for do tipo Get e o Request Recebe
							// qualquer um Post ou Get
	...
	public String userUpdate(@PathVariable("id") Integer id, Model model) { // variavel cujo o valor está inserido na
																			// URL

		Optional<User> optUser = userRepository.findById(id); // Optional usado pra evitar erros (verificar se o obj n é
																// nulo)
